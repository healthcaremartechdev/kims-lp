...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-17011074142"></script>
<script>
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6 col-md-6 mb-lg-0 mb-3">
            <div class="sec-title">
              <h2>KIMSHEALTH Nagercoil Urology Institute</h2>
              <p>One of The Best Urology Hospitals in Tamil Nadu</p>
            </div>
            <div class="about-content">
              <p>The Urology department at KIMSHEALTH provides a one-stop solution to diseases related to the urinary tract, whether it is cancer, prostate-related issues, stones, birth defects, neurologic afflictions of the urinary tract, pediatric urologic problems, etc. The urology expert at KIMSHEALTH is also adept in managing problems related to the sexual and reproductive functions of men.  Our doctor uses innovative surgical technology to perform surgeries and minimally invasive procedures to treat their patients with a wide variety of urologic problems. KIMSHEALTH takes pride in providing quality healthcare with compassion and competence.</p>
            </div>
          </div>
          <div class="col-lg-5 col-md-5 my-lg-auto doctor-col-custom">
            ...
            <div class="owl-carousel owl-theme video-slider dots-morphing">
              <div class="video-item">
                <iframe width="100%" height="300" src="https://www.youtube.com/embed/DuzDs2DHbqk" title="prostate health | Dr. Sukhdev B Singh, Associate Consultant at the Department of Urology." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
              <div class="video-item">
              ...
              <div class="col-lg-10">
                <div class="owl-carousel owl-theme mb-0 specility_card dots-morphing">
                  ...
                  <div class="card border-0 box-shadow-1 box-shadow-1-primary">
                    <div class="card-body py-4 px-4">
                      <div class="pt-2 pb-3">
                        <h5>Laparoscopic Urology</h5>
                        <div class="under-line"></div>
                        <p>Offers minimally invasive surgeries for diagnoses like pelvi ureteric junction and ureteropelvic junction obstruction, adrenal tumors.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="owl-carousel owl-theme dots-morphing mb-0 expart-slider">
          ...
          <div class="expart-card">
            ...
            <div class="card-content mt-3">
              <h3> Dr. Sukhdev D B Singh </h3>
              <p>Consultant Urologist</p>
              <h4>MS (General Surgery) , MCh Urology - CMC Vellore</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="owl-carousel owl-theme mb-0 testimonial-slider dots-morphing mt-5">
          <div class="testimonial-content-card ">
            ...
            <p>Dr. Sukhdev, Urologist, treated me well, he cares me well. Often he will visit me and cares me well. He is very kind. I was admitted for the TURB Surgery. It was well done. Now I'm feeling good. Thanks for the Doctor. I'll highly recommend KIMS Nagercoil to everyone. One of the best hospital in Kanyakumari district.
            </p>
          </div>
          <div class="testimonial-content-card ">
            <div class="d-flex testimonial-main-area">
