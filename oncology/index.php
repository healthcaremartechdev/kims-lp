      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6 col-md-6 mb-lg-0 mb-3">
            <div class="sec-title">
              <h2>KIMSHEALTH Oncology Institute</h2>
              <p>One Of The Best Cancer Hospitals In Kerala</p>
            </div>
          ...
          <div class="col-lg-5 col-md-6 my-lg-auto pt-lg-5">
            <div class="owl-carousel owl-theme video-slider dots-morphing">
              <div class="video-item">
                <iframe width="100%" height="300" src="https://www.youtube.com/embed/jmx2bOIXkqY" title="KIMSHEALTH EAST : An Integrated Healthcare Destination" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="card border-0 box-shadow-1 box-shadow-1-primary">
                    <div class="card-body py-4 px-4">
                      <div class="pt-2 pb-3">
                        ...
                        <div class="under-line"></div>
                        <p>Uses chemotherapy, immunotherapy, and targeted therapy for systemic cancer treatment,
                          addressing cancer cells throughout the body.</p>
                      </div>
                    </div>
                  </div>
        ...
        <div class="owl-carousel owl-theme dots-morphing mb-0 expart-slider">
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-jayaprakash-madhavanpng__247x278_q85_crop_subsampling-2.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Jayaprakash Madhavan</h3>
              <p>Sr. Consultant</p>
              <h4>MBBS, MDDNB, DMR, FICRD</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-grace-shirleypng__247x278_q85_crop_subsampling-2.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. E. Grace Shirley</h3>
              <p>Consultant</p>
              <h4>MBBS, DMRT, DNB</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          ...
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-abdul-shahidpng__247x278_q85_crop_subsampling-2.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. P.P.Abdul Shahid</h3>
              <p>Consultant</p>
              <h4>DM (Medical oncology), M.D. (General Medicine), M.B.B.S, Professional Certification Course on Multiple
                Myeloma, Myelokraft,</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-jayanand-sunilpng__247x278_q85_crop_subsampling-2.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. B Jayanand Sunil</h3>
              <p>Consultant & Coordinator, Surgical …</p>
              <h4>MBBS, MS, DNB, MCh (Onco)</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/img_8596.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Bharath V M</h3>
              <p>Consultant</p>
              <h4>Completed MBBS from Vinayaka Mission Medical college, Pondicherry in 2005, Passed MS in General
                Surgery from Govt. Medical College, Trivandrum in 2011, Completed M.Ch in Surgical Oncology from
                Regional Cancer Centre, Trivandrum in 2015, Has Fellowship in International College of Robotic Surgeons
                (Gurgaon 2016), Fellowship in Minimal Access, Oncosurgery (Indoamerican Hospital, Hyderabad, 2015)</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-amrita-b-raopng__247x278_q85_crop_subsampling-2.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Amrita B Rao</h3>
              <p>Associate Consultant</p>
              <h4>Completed M.B.B.S from Byramjee jeejeebhoy Hospital Pune in 2007., Passed M.S in General Surgery from
                Trivandrum Medical College in 2012 ., Completed MCh in Plastic Reconstructive and Microvascular surgery
                from Tata Memorial Centre Mumbai in 2017.</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/new_photo_11.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Azgar Abdul Rasheed</h3>
              <p>Associate Consultant</p>
              <h4>Graduation from Government Medical College, Trivandrum, MD (Pediatrics), DM (Medical Oncology) from
                AIIMS, New Delhi</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/arun_v.png" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Arun V</h3>
              <p>Associate Consultant</p>
              <h4>Graduation from Govt. T D Medical College, Allepey, MD (Radiation Oncology), DM (Medical Oncology)
                from Regional Cancer Centre, Trivandrum</h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/shabin.png" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Shabin K Sidhique</h3>
          ...
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/img_20230703_150410_1.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. John Sebastian MG</h3>
              <p>Consultant</p>
              <h4>MBBS- Government Medical College, Trivandrum, MD (Radiation Oncology)- MS Ramaiah Medical College,
                Bangalore, DNB (Radiation Oncology)- National Board of Examinations</h4>
              <a href="#" class="btn btn-primary">Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr_aswin_v_nairnew.png" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Ashwin V Nair</h3>
              <p>Associate Consultant</p>
              <h4>DM Clinical Hematology, MD Internal Medicine, MBBS</h4>
              <a href="#" class="btn btn-primary">Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/narayan.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Narayanan R</h3>
              <p>Associate Consultant</p>
              <h4>M.B.B.S, M.S, DNB, DNB</h4>
              <a href="#" class="btn btn-primary">Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
            ...
            <div class="card-content mt-3">
              <h3>Dr. Jacob Kurian</h3>
              <p>Senior Consultant</p>
              <h4>MBB–Medical College, Kottayam 1979, MS – Medical College, Kottayam 1987, MCH – (Oncology) Cancer
                Institute, Madras 1991</h4>
              <a href="#" class="btn btn-primary">Request An Appointment </a>
            </div>
          </div>
        </div>
