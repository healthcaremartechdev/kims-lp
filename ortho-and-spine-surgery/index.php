        ...
        <div class="row justify-content-between">
          <div class="col-lg-6 col-md-6 mb-lg-0 mb-3">
            <div class="sec-title">
              ...
              <p>One Of The Best Orthopaedic Hospitals In Kerala</p>
            </div>
    ...
    <section class="section section-bg" id="expert">
      <div class="container">
        ...
        <div class="owl-carousel owl-theme dots-morphing mb-0 expart-slider">
          ...
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-rajesh-pillai.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
          ...
          <div class="expart-card">
            <div class="expert-image position-relative">
              <img src="image/dr-manjoj-haridas.png" alt="" class="img-fluid">
            </div>
            <div class="card-content mt-3">
              <h3>Dr. Manoj Haridas</h3>
              <p>Senior Consultant Hand & Microvascular Surgeon</p>
              <h4>MBBS, MS Orthopedics, D Orthopedics </h4>
              <a href="#" class="btn btn-primary"> Request An Appointment </a>
            </div>
          </div>
          <div class="expart-card">
